...
register(
    id='HierarchicalHalfCheetah-v0',
    entry_point='gym.envs.mujoco:HierarchicalHalfCheetahEnv',
    max_episode_steps=1500,
)

register(
    id='HalfCheetahHier-v2',
    entry_point='gym.envs.mujoco:HalfCheetahHierEnv',
...
register(
    id='Quadruped-v0',
    entry_point='gym.envs.mujoco:QuadrupedEnv',
    max_episode_steps=1000,
)

register(
    id='CrippledAnt-v0',
    entry_point='gym.envs.mujoco:CrippledAntEnv',
...
register(
    id='Hurdle-v0',
    entry_point='gym.envs.mujoco:HurdleEnv',
...
register(
    id='AntMulti-v0',
    entry_point='gym.envs.mujoco:MultiAntEnv',
    max_episode_steps=500,
)
